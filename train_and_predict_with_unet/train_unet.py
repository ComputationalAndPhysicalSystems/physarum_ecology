...
CLASS_WEIGHTS = [0.25, 0.25, 0.25, 0.25, 0.25]
N_EPOCHS = 50
UPCONV = False
PATCH_SZ = 64   # should divide by 16
BATCH_SIZE = 10
TRAIN_SZ = 3000  # train size
VAL_SZ = 1000    # validation size
TRAIN_DIR = "/home/lpe/Desktop/png_unet_train/output/"
TEST_DIR = "/home/lpe/Desktop/png_unet_train/input/"
...
sorted_dir_listttt = glob.glob(TRAIN_DIR + "*.png*")
print(sorted_dir_listttt)
...
if __name__ == '__main__':
    ...
    for img_id in trainIds:
        ...
        img_m = normalize(cv2.imread(sorted_dir_list1[numpy_listinds]))
